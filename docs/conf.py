#
# Sphinx config file for immutable-views project.
#
...
version = get_version(os.path.join('..', 'immutable_views', '_version.py'))
...
htmlhelp_basename = 'immutable_views_doc'
...
latex_documents = [
    (master_doc, 'immutable_views.tex', _short_description, author, 'manual'),
]
...
man_pages = [
    (master_doc, 'immutable_views', _short_description, [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'immutable_views', _short_description,
     author, 'immutable_views', _short_description,
     'Miscellaneous'),
]
